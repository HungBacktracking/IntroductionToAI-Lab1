...
class Interface(object):
    ...
    def make_background(self):
        ...
        image = pg.Surface((440 * 2,280 * 2)).convert()
        image.set_colorkey((255,0,255))
        image.fill((255,0,255),(20 * 2,20 * 2,400 * 2,240 * 2))
        for i in range(21):
            image.fill((255,0,0),(20 * 2+20 * 2*i,20 * 2,2,242 * 2))
        for i in range(13):
            image.fill((255,0,0),(20 * 2,20 * 2+20 * 2*i,400 * 2,2))
        return image
