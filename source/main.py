...
Y_OFFSET = 10
delay = 100
WALL_IMG1 = pygame.image.load('./source/assets/fence.png')
START_IMG1 = pygame.image.load('./source/assets/star.png')
FAIL_IMG1 = pygame.image.load('./source/assets/fail.png')
EXIT_IMG1 = pygame.image.load('./source/assets/house.png')
GIFT_IMG1 = pygame.image.load('./source/assets/tree.png')
TIM1_IMG1 = pygame.image.load('./source/assets/paw.png')
TIM2_IMG1 = pygame.image.load('./source/assets/cat.png')
CLOSE_IMG1 = pygame.image.load('./source/assets/close.png')
OPEN_IMG1 = pygame.image.load('./source/assets/open.png')
TELEPORT1 = pygame.image.load('./source/assets/tele.png')
TELEPORT_OUT1 = pygame.image.load('./source/assets/teleout.png')

TIM_U_IMG1 = pygame.image.load('./source/assets/cat.png')
TIM_L_IMG1 = pygame.image.load('./source/assets/cat_l.png')
TIM_R_IMG1 = pygame.image.load('./source/assets/cat_r.png')
TIM_D_IMG1 = pygame.image.load('./source/assets/cat_d.png')

RETIM_U_IMG1 = pygame.image.load('./source/assets/recat_u.png')
RETIM_L_IMG1 = pygame.image.load('./source/assets/recat_l.png')
RETIM_R_IMG1 = pygame.image.load('./source/assets/recat_r.png')
RETIM_D_IMG1 = pygame.image.load('./source/assets/recat_d.png')
...
def main(argv):
    if 'advance' == argv[1]:
        path = "./input/advance/input{0}.txt".format(argv[2])
        level = 'advance'
    else:    
        path = "./input/level_{0}/input{1}.txt".format(argv[1],argv[2])
        level =  "level_" + argv[1]
    algName=argv[3]
    input = "input"+ argv[2]
